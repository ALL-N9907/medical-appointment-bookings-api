...
public class AppointmentTypeMapper {
    ...
    public AppointmentType toEntity(AppointmentTypeDTOs.CreateAppointmentTypeRequest req){
        return AppointmentType.builder().name(req.name()).durationMinutes(req.durationMinutes()).build();
    }

    public AppointmentTypeDTOs.AppointmentTypeResponse toResponse(AppointmentType at){
