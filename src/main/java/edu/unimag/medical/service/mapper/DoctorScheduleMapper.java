...
public class DoctorScheduleMapper {
    ...
    public DoctorSchedule toEntity(DoctorScheduleDTOs.CreateDoctorScheduleRequest req, Doctor doctor){
        return DoctorSchedule.builder().startAt(req.startAt()).endAt(req.endAt()).dayOfWeek(req.dayOfWeek()).doctor(doctor).build();
    }
    public DoctorScheduleDTOs.DoctorScheduleResponse toResponse(DoctorSchedule ds){
